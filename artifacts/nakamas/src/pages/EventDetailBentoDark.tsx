...
function Group({ group, event, navigate }: { group: any; event: any; navigate: any; key?: any }) {
  ...
  return (
    <div 
      className="group relative rounded-xl border border-gray-700 bg-gray-800 border-gray-700 text-white p-4 shadow-sm hover:border-emerald-700 hover:shadow-md transition-all cursor-pointer overflow-hidden mt-2" 
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2 flex-wrap justify-end">
            <button 
              onClick={handleSave}
              className={`flex items-center gap-2 text-[10px] font-bold  tracking-wider transition-colors px-3 py-1 rounded-full ${isSaved ? 'text-emerald-400 bg-emerald-900/50' : 'text-white hover:text-emerald-400 bg-gray-800/70 hover:bg-gray-800 border border-gray-700'}`}
            >
            ...
            <button 
              ...
              className="flex items-center gap-2 text-[10px] font-bold  tracking-wider text-white hover:text-emerald-400 transition-colors bg-gray-800/70 hover:bg-gray-800 border border-gray-700 px-3 py-1.5 rounded-full"
            >
          ...
          <section className="space-y-4 text-[13px] text-white leading-relaxed bg-gray-800 border-gray-700 text-white rounded-xl border border-gray-700 p-5 md:p-6 shadow-sm">
             ...
             <div className="pt-5 border-t border-gray-700 mt-5">
               ...
               {event.externalLink && (
                 <div className="mt-4 pt-1">
                   <a href={event.externalLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 border border-gray-700 text-white bg-gray-800 border-gray-700 text-white hover:bg-gray-700/60 hover:text-emerald-400 hover:border-emerald-800 transition-colors shadow-sm text-xs font-bold tracking-wide rounded-lg w-full sm:w-auto justify-center">
             ...
             {organizer && (
               <div className="pt-5 border-t border-gray-700 mt-5">
                 ...
                 <div className="flex items-center justify-between p-4 rounded-xl border border-gray-700 bg-gray-800 border-gray-700 text-white shadow-sm hover:border-emerald-800 transition-colors">
