...
export default function NearbyGroupsBentoDark() {
    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#e5e3df] z-0 flex items-center justify-center">
          ...
          {localGroups.map((group, idx) => {
            ...
            return (
              ...
              >
                {!isSelected && (
                  <div className="bg-gray-800 border-gray-700 text-white text-white text-xs font-bold px-2 py-1 rounded shadow-lg mb-1 group-hover:-translate-y-1 transition-transform whitespace-nowrap border border-gray-700">
                    {group.category} • {(1.2 + idx * 0.8).toFixed(1)}km
                  </div>
                )}

                {isSelected && (
                  <div className="absolute bottom-full mb-2 bg-gray-800 border-gray-700 text-white rounded-lg shadow-xl border border-gray-700 p-3 w-48 z-20">
                    <button
                    ...
                    <button
                      className="w-full bg-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.5)] border border-gray-700 text-white text-[10px] font-bold tracking-wide py-1.5 rounded-md hover:bg-black transition-colors"
          ...
          <div className="absolute top-[80px] left-[50%] transform -translate-x-1/2 bg-gray-800 border-gray-700 text-white/90 backdrop-blur text-white text-xs px-3 py-1.5 rounded-full border border-gray-700 shadow-sm z-10">
            {t(
        ...
        <div className="absolute top-4 left-4 right-4 z-10 flex gap-2 pointer-events-none">
          ...
          <button className="h-11 px-4 bg-gray-800 border-gray-700 text-white/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-white hover:text-emerald-400 transition-colors pointer-events-auto" aria-label={t('Φίλτρα', 'Filters')}>
            <SlidersHorizontal className="h-5 w-5" />
          </button>
        </div>

        {/* Slide-up Panel for Mobile, Sidebar for Desktop */}
        <div className="absolute bottom-0 left-0 right-0 md:top-0 md:bottom-0 md:right-auto md:w-96 bg-gray-800 border-gray-700 text-white shadow-[0_-10px_40px_rgba(0,0,0,0.1)] md:shadow-[10px_0_40px_rgba(0,0,0,0.1)] z-20 flex flex-col rounded-t-3xl md:rounded-none transition-transform duration-300 transform translate-y-0 max-h-[60vh] md:max-h-full">
          ...
          <div className="p-4 md:p-6 border-b border-gray-800 shrink-0">
            ...
            <div className="flex gap-2 mt-4 overflow-x-auto noscrollbar pb-1">
              ...
              <button className="px-3 py-1.5 bg-gray-800/70 text-white border border-gray-700 rounded-full text-xs font-bold whitespace-nowrap hover:bg-gray-800 border border-gray-700">
                {t("Σήμερα", "Today")}
              </button>
              <button className="px-3 py-1.5 bg-gray-800/70 text-white border border-gray-700 rounded-full text-xs font-bold whitespace-nowrap hover:bg-gray-800 border border-gray-700">
          ...
          <div className="overflow-y-auto flex-1 p-4 space-y-3 text-left">
            ...
            <div className="p-6 text-center border border-dashed border-gray-700 rounded-xl bg-gray-800/70">
              ...
              <button
                ...
                className="text-xs font-bold text-white bg-gray-800 text-white border border-gray-700 shadow-[0_8px_30px_rgb(0,0,0,0.5)] px-4 py-2 rounded-full hover:bg-gray-800 transition-colors"
              >
                Set radius to 15km
              </button>
            </div>
  ...
  return (
    ...
    >
        ...
        <ErrorBoundary
          fallback={
            <div className="w-full h-full flex items-center justify-center bg-[#e5e3df] p-8 text-center">
              <div className="bg-gray-800 border-gray-700 text-white p-6 rounded-xl shadow-lg max-w-sm border border-red-100">
              ...
              >
                <Popup>
                  ...
                  >
                    ...
                    <button className="w-full bg-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.5)] border border-gray-700 text-white text-[10px] font-bold tracking-wide py-1.5 rounded-md hover:bg-black transition-colors">
      ...
      >
        {!isMapFullscreen && (
          <div className="relative flex-1 max-w-sm pointer-events-auto shadow-lg bg-gray-800 border-gray-700 text-white/95 backdrop-blur rounded-xl">
            <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-white" />
            <input
              type="text"
        ...
        {!isMapFullscreen && (
          <button
            ...
            className="h-11 px-4 bg-gray-800 border-gray-700 text-white/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-white hover:text-emerald-400 transition-colors pointer-events-auto shrink-0"
        ...
        <button
          ...
          className="h-11 px-4 bg-gray-800 border-gray-700 text-white/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-emerald-400 hover:text-emerald-400 transition-colors pointer-events-auto shrink-0 ml-auto"
        ...
        <button
          ...
          className="h-11 px-4 bg-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.5)] border border-gray-700 text-white rounded-xl shadow-lg flex items-center justify-center hover:bg-black transition-colors pointer-events-auto shrink-0"
      ...
      {/* Slide-up Panel for Mobile, Sidebar for Desktop */}
      <div
        className={`absolute bottom-0 left-0 right-0 md:top-0 md:bottom-0 md:right-auto bg-gray-800 border-gray-700 text-white shadow-[0_-10px_40px_rgba(0,0,0,0.1)] md:shadow-[10px_0_40px_rgba(0,0,0,0.1)] z-20 flex flex-col rounded-t-3xl md:rounded-none transition-transform duration-300 transform translate-y-0 dynamic-sidebar-width ${isMapFullscreen ? "translate-y-full md:-translate-x-full" : isPanelExpanded ? "top-0 md:h-full" : "max-h-[60vh] md:max-h-full"} ${isDragging ? "transition-none" : ""}`}
      >
