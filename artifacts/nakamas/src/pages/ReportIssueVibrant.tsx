        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-5">
            <div>
              ...
              <select className="w-full h-11 px-3 rounded-lg border border-gray-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-fuchsia-600 focus:border-transparent text-[16.2px] font-medium" required>
            ...
            <div>
              ...
              <textarea 
                className="w-full px-3 py-2.5 rounded-lg border border-gray-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-fuchsia-600 focus:border-transparent text-[16.2px] font-medium resize-none" 
                rows={5} 
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center hover:border-fuchsia-300 hover:bg-fuchsia-50/30 transition-colors cursor-pointer">
            ...
            <div className="bg-gray-50 rounded-lg p-4 flex items-start gap-3">
              <ShieldCheck className="w-5 h-5 text-fuchsia-600 shrink-0 mt-0.5" />
