    ...
    return (
      ...
      >
        ...
        <div className="absolute top-4 left-4 right-4 z-10 flex gap-2 pointer-events-none">
          ...
          <button className="h-11 px-4 bg-gray-800/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-white hover:text-emerald-400 transition-colors pointer-events-auto" aria-label={t('Φίλτρα', 'Filters')}>
