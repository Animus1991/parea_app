...
export default function NearbyGroupsVibrantDark() {
    ...
    return (
      ...
      >
              ...
              >
                ...
                {isSelected && (
                  <div className="absolute bottom-full mb-2 bg-gray-800 rounded-lg shadow-xl border border-gray-700 p-3 w-48 z-20">
                    ...
                    <button
                      className="w-full bg-gradient-to-br from-red-900 via-rose-900 to-red-800 text-white text-[10px] font-bold tracking-wide py-1.5 rounded-md hover:bg-black transition-colors"
        ...
        <div className="absolute top-4 left-4 right-4 z-10 flex gap-2 pointer-events-none">
          ...
          <button className="h-11 px-4 bg-gray-800/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-white hover:text-fuchsia-400 transition-colors pointer-events-auto" aria-label={t('Φίλτρα', 'Filters')}>
          ...
          <div className="overflow-y-auto flex-1 p-4 space-y-3 text-left">
            ...
            <div className="p-6 text-center border border-dashed border-gray-700 rounded-xl bg-gray-800/70">
              ...
              <button
                ...
                className="text-xs font-bold text-white bg-gradient-to-br from-red-900 via-rose-900 to-red-800 text-white px-4 py-2 rounded-full hover:bg-gray-800 transition-colors"
              >
                Set radius to 15km
              </button>
            </div>
    ...
    >
              ...
              >
                <Popup>
                  ...
                  >
                    ...
                    <button className="w-full bg-gradient-to-br from-red-900 via-rose-900 to-red-800 text-white text-[10px] font-bold tracking-wide py-1.5 rounded-md hover:bg-black transition-colors">
      ...
      >
        ...
        <button
          ...
          className="h-11 px-4 bg-gradient-to-br from-red-900 via-rose-900 to-red-800 text-white rounded-xl shadow-lg flex items-center justify-center hover:bg-black transition-colors pointer-events-auto shrink-0"
