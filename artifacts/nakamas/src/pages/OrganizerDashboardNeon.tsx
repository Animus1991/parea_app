    ...
    <div className="mx-auto max-w-full space-y-8 pb-12">
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[12.1125px] font-bold text-emerald-600">72%</span>
        </div>
        <div className="w-full bg-gray-100 h-2 rounded-full overflow-hidden">
          <div className="bg-gradient-to-r from-emerald-500 to-emerald-500 h-full rounded-full" style={{ width: '72%' }} />
        </div>
      ...
      <div>
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 noscrollbar">
          {[
            ...
            <button key={tpl.label} onClick={() => navigate('/create')} className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-gray-200 bg-white hover:bg-emerald-50 hover:border-emerald-200 transition-colors text-[12.5px] font-bold text-black">
          ...
          <div className="p-4 bg-white grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="md:col-span-2 space-y-3">
               ...
               <div className="flex items-center justify-between p-3 bg-gray-50 rounded border border-gray-100">
                  ...
                  <div className="flex gap-2">
                    <button className="p-1.5 bg-white text-emerald-600 rounded shadow-sm border border-gray-200 hover:bg-emerald-50" aria-label={t('Μήνυμα ομάδας', 'Message group')} title={t('Μήνυμα ομάδας', 'Message group')}>
          ...
          <div className="p-4 bg-white grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="md:col-span-2 space-y-3">
               ...
               <div className="flex items-center justify-between p-3 bg-emerald-50 rounded border border-emerald-100">
                  <div>
                    <p className="text-[15px] font-bold text-emerald-900">{t(`Ομάδα #1`, `Group #1`)} — 3/4</p>
                    <p className="text-[12.5px] text-emerald-600 mt-0.5">{t(`Νέο μήνυμα`, `New message`)}</p>
                  </div>
                  <div className="flex gap-2">
                    <button className="p-1.5 bg-white text-emerald-600 rounded shadow-sm border border-emerald-200 hover:bg-emerald-100 relative" aria-label={t('Μήνυμα ομάδας', 'Message group')} title={t('Μήνυμα ομάδας', 'Message group')}>
                      <MessageSquare className="w-3.5 h-3.5" />
