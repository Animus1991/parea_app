      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2 flex-wrap justify-end">
            <button 
              onClick={handleSave}
              className={`flex items-center gap-2 text-[10px] font-bold  tracking-wider transition-colors px-3 py-1 rounded-full ${isSaved ? 'text-fuchsia-400 bg-fuchsia-900/50' : 'text-white hover:text-fuchsia-400 bg-gray-800/70 hover:bg-gray-700'}`}
            >
            ...
            <button 
              ...
              className="flex items-center gap-2 text-[10px] font-bold  tracking-wider text-white hover:text-fuchsia-400 transition-colors bg-gray-800/70 hover:bg-gray-700 px-3 py-1.5 rounded-full"
            >
