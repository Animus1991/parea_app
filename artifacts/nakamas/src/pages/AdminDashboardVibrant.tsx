        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-[12.5px] font-bold text-fuchsia-600">72%</span>
            </div>
            <div className="w-full bg-gray-100 h-1.5 rounded-full"><div className="bg-fuchsia-500 h-full rounded-full" style={{ width: '72%' }} /></div>
          </div>
        </div>
      </Card>
            ...
            <Card className="p-5 bg-gray-50 border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 text-[18px] border border-gray-300 rounded-lg focus:ring-2 focus:ring-fuchsia-600 focus:outline-none bg-white">
