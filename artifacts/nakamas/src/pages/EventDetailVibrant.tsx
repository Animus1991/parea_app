...
function Group({ group, event, navigate }: { group: any; event: any; navigate: any; key?: any }) {
  ...
  return (
    <div 
      className="group relative rounded-xl border border-gray-200 bg-white p-4 shadow-sm hover:border-fuchsia-300 hover:shadow-md transition-all cursor-pointer overflow-hidden mt-2" 
    ...
    >
      ...
      <div className="flex justify-between items-start mb-3 mt-1">
        <div>
          ...
          <span className="text-[9px] tracking-widest font-bold text-fuchsia-600 bg-fuchsia-50 px-2 py-0.5 rounded-full mb-2 inline-block shadow-sm">
            {event.category}
          </span>
              ...
              <div className="relative">
                <div className="h-8 w-8 rounded-full bg-gray-200 overflow-hidden shrink-0 border border-gray-200">
                   {groupHost.photoUrl ? (
                     ...
                     <div className="h-full w-full flex items-center justify-center bg-fuchsia-100 text-fuchsia-700 font-bold text-xs">
      ...
      <Button 
        variant="primary" 
        size="sm" 
        className="w-full bg-fuchsia-50 text-fuchsia-700 border border-fuchsia-100 hover:bg-fuchsia-600 hover:text-white transition-colors group-hover:bg-fuchsia-600 group-hover:text-white font-semibold shadow-sm"
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2 flex-wrap justify-end">
            <button 
              onClick={handleSave}
              className={`flex items-center gap-2 text-[10px] font-bold  tracking-wider transition-colors px-3 py-1 rounded-full ${isSaved ? 'text-fuchsia-800 bg-fuchsia-100' : 'text-black hover:text-fuchsia-600 bg-gray-50 hover:bg-gray-100'}`}
            >
            ...
            <button 
              ...
              className="flex items-center gap-2 text-[10px] font-bold tracking-wide text-fuchsia-600 hover:text-fuchsia-800 transition-colors bg-fuchsia-50 px-3 py-1.5 rounded-full"
            >
            ...
            <button 
              onClick={handleShare}
              className="flex items-center gap-2 text-[10px] font-bold  tracking-wider text-fuchsia-600 hover:text-fuchsia-800 transition-colors bg-fuchsia-50 px-3 py-1.5 rounded-full"
            >
            ...
            <button 
              ...
              className="flex items-center gap-2 text-[10px] font-bold  tracking-wider text-black hover:text-fuchsia-600 transition-colors bg-gray-50 hover:bg-gray-100 px-3 py-1.5 rounded-full"
            >
          ...
          <section className="space-y-4 text-[13px] text-[#111827] leading-relaxed bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm">
                ...
                <div className="space-y-3 col-span-2 sm:col-span-1">
                 ...
                 <div className="space-y-1 col-span-2 sm:col-span-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link to="/trust" className="text-[11px] text-fuchsia-600 font-bold underline">{t('Γιατί;', 'Why?')}</Link>
                  </div>
                </div>
             </div>
             ...
             <div className={`${isMapFullscreen ? 'fixed !inset-0 !z-[9999] bg-black !m-0 rounded-none !h-[100dvh]' : 'mt-6 w-full h-64 sm:h-80 rounded-lg'} bg-gray-100 overflow-hidden relative border border-gray-200 transition-all duration-300`}>
                  <button 
                    ...
                    className="absolute top-4 right-4 z-10 p-2 bg-white/90 backdrop-blur rounded-lg shadow-md text-black hover:text-fuchsia-600 transition-colors"
                  >
             ...
             {organizer && (
               <div className="pt-5 border-t border-gray-200 mt-5">
                 ...
                 <div className="flex items-center justify-between p-4 rounded-xl border border-gray-200 bg-white shadow-sm hover:border-fuchsia-200 transition-colors">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-full overflow-hidden bg-fuchsia-50 border-2 border-white ring-2 ring-fuchsia-50 shrink-0">
                        {organizer.photoUrl ? (
                          <img referrerPolicy="no-referrer" src={organizer.photoUrl} alt={organizer.name} className="w-full h-full object-cover" />
                        ) : (
                          <div className="w-full h-full flex items-center justify-center text-fuchsia-500 font-bold text-lg">{organizer.name.substring(0, 2).toUpperCase()}</div>
                        )}
                      </div>
                      <div>
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <Link to={`/profile`} className="text-base font-bold text-[#111827] hover:text-fuchsia-600 transition-colors">
                            {organizer.name}
                          </Link>
                          {organizer.trustTier && (
