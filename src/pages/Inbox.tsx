...
export default function Inbox() {
  ...
  const chats = [
    {
      id: 'g1',
      title: t('Stand-up Comedy Παρασκευή', 'Stand-up Comedy Friday'),
      lastMessage: t('Συναντιόμαστε στην είσοδο;', 'Are we meeting at the entrance?'),
      time: '12:30',
      unread: 3,
    ...
    {
      id: 'g2',
      title: t('Καφέ με Επιτραπέζια', 'Board Games Cafe'),
      lastMessage: t('Θα φέρω το Catan!', 'I will bring Catan!'),
    ...
    {
      id: 'g3',
      title: t('Πρωινή Πεζοπορία', 'Sunday Morning Hike'),
      lastMessage: t('Φοβερή διαδρομή παιδιά, ευχαριστώ!', 'Awesome trail guys, thanks!'),
      time: t('Δευ', 'Mon'),
      unread: 0,
  ...
  return (
    <div className="max-w-full mx-auto space-y-6 animate-in slide-in-from-bottom-4 duration-500 fade-in pb-20 md:pb-0 h-[calc(100vh-100px)] flex flex-col">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 shrink-0">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-[#111827]">{t('Ομαδικά Chats', 'Group Chats')}</h1>
          <p className="text-gray-500 font-medium text-xs md:text-sm mt-1">{t('Μείνετε συνδεδεμένοι με τις ομάδες των εκδηλώσεών σας.', 'Stay connected with your event groups.')}</p>
        </div>
      </div>
      ...
      <div className="relative shrink-0">
        ...
        <input 
          ...
          placeholder={t('Αναζήτηση μηνυμάτων ή ομάδων...', 'Search messages or groups...')} 
        ...
        {chats.map((chat) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] text-gray-500 mt-1 capitalize tracking-tight font-semibold">
                {chat.participants} {t('Μέλη', 'Members')}
              </p>
            </div>
          </div>
        ))}
