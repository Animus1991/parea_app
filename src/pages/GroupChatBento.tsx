...
export default function GroupChatBento() {
  const { t } = useLanguage();
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            className={`max-w-[85%] sm:max-w-[75%] md:max-w-[65%] rounded-2xl px-4 py-2.5 text-base leading-relaxed relative ${
              isMe
                ? "bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-black rounded-tr-sm shadow-sm"
                ...
                <div className="flex items-center justify-end gap-1 sm:gap-2 shrink-0">
                  ...
                  <div className="hidden md:flex items-center gap-3 mr-2">
                    <select
                      ...
                      className="text-xs font-bold border border-gray-200 rounded-lg px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-indigo-500 bg-gray-50 text-black hover:bg-gray-100 cursor-pointer transition-colors max-w-[120px] truncate"
                    >
                      <option value="all">
                    ...
                    <div className="relative group">
                      <Search className="h-3.5 w-3.5 text-black absolute left-2.5 top-1/2 -translate-y-1/2 group-focus-within:text-indigo-500 transition-colors" />
                      <input
                        type="text"
                  ...
                  <button
                    ...
                    className={`transition-colors p-2 rounded-full ${showInfo ? "text-indigo-600 bg-indigo-50" : "text-black hover:text-[#111827] hover:bg-gray-100"}`}
                  >
            ...
            <div className="flex items-center gap-2 md:gap-3 max-w-4xl mx-auto w-full relative">
              ...
              <div className="flex-1 relative">
                ...
                <button
                  ...
                  className="absolute right-1.5 top-1/2 -translate-y-1/2 p-2 bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-black rounded-full hover:bg-gray-800 disabled:opacity-40 disabled:hover:bg-white text-black border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all shadow-sm"
                >
                  ...
                  {event.tags && event.tags.length > 0 && (
                    <div className="flex gap-1.5 flex-wrap">
                      {event.tags.map((tag: string) => (
                        <span
                          key={tag}
                          className="bg-indigo-50 text-indigo-700 px-2.5 py-1 rounded-md text-xs font-bold tracking-wide border border-indigo-100"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <div className="flex items-center gap-2">
                    {isGroupAdmin && (
                      <button
                        ...
                        className="flex items-center gap-1 text-xs font-bold text-indigo-600 hover:text-indigo-700 bg-indigo-50 hover:bg-indigo-100 px-2 py-1 rounded border border-indigo-100 transition-colors"
                      >
                        ...
                        >
                          <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden shrink-0 relative group shadow-sm border border-gray-100">
                            {member.photoUrl ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center text-black font-bold text-xs bg-indigo-50 text-indigo-700">
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#111827] focus:ring-offset-2 ${isEphemeral ? "bg-white text-black border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]" : "bg-gray-200"}`}
                    >
                ...
                <div className="pt-4 border-t border-gray-100">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <div>
                        <p
                          className={`text-sm font-bold ${isSharingLocation ? "text-indigo-700" : "text-[#111827]"}`}
                        >
                          {isSharingLocation
                        ...
                        <p
                          className={`text-xs mt-0.5 ${isSharingLocation ? "text-indigo-600/80" : "text-black"}`}
                        >
                          {isSharingLocation
                      ...
                      <MapPin
                        className={`w-4 h-4 ${isSharingLocation ? "text-indigo-600" : "text-black"}`}
                      />
                    </button>
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto custom-scrollbar border border-gray-100 animate-in zoom-in-95 duration-200">
              ...
              <div className="p-5 border-t border-gray-100 bg-gray-50/50">
                <button
                  ...
                  className="w-full px-4 py-3 text-sm font-bold text-white bg-white text-black border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:bg-gray-900 rounded-xl transition-all shadow-sm active:scale-[0.98]"
                >
                  {isSharingLocation
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 border border-gray-100 animate-in zoom-in-95 duration-200">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 text-sm font-bold text-white bg-white text-black border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:bg-gray-900 rounded-xl transition-all shadow-sm hover:shadow-md"
                >
              ...
              <div className="flex flex-col gap-2.5">
                ...
                >
                  <input
                    ...
                    className="flex-1 w-full bg-gray-50 border border-gray-200 text-black text-sm rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
                    min="1"
                  />
                  <button
                    type="submit"
                ...
                {[
                  {
                    ...
                    color: "bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-black hover:bg-gray-900",
                  },
                  {
              ...
              <div className="p-4 sm:p-5 bg-gray-50/50 border-b border-gray-100">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-600 bg-white transition-all shadow-sm font-medium"
                  />
                </div>
              </div>
                    ...
                    .map((member) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="text-sm font-semibold capitalize tracking-tight px-3 py-1.5 rounded-lg border flex items-center gap-1 transition-all bg-indigo-600 text-white border-indigo-600 hover:bg-indigo-700 shadow-sm"
                        >
                          <UserPlus className="w-3 h-3" />{" "}
                          {t("Προσθήκη", "Add")}
                        </button>
