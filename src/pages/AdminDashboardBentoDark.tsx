      ...
      <Card className="p-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <div className="w-full bg-gray-800 border border-gray-700 h-1.5 rounded-full"><div className="bg-cyan-500 h-full rounded-full" style={{ width: '72%' }} /></div>
          </div>
        </div>
      </Card>
            ...
            <Card className="p-5 bg-gray-900 border-gray-700">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 text-[18px] border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-600 focus:outline-none bg-gray-800 border-gray-700 text-white">
