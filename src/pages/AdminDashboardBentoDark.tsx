...
export default function AdminDashboardBentoDark() {
    const { t } = useLanguage();
  return (
      ...
      <Card className="p-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            <div className="w-full bg-gray-800 border border-gray-700 h-1.5 rounded-full"><div className="bg-emerald-500 h-full rounded-full" style={{ width: '87%' }} /></div>
          </div>
          <div>
            <div className="flex items-center justify-between mb-1">
            ...
            <div className="w-full bg-gray-800 border border-gray-700 h-1.5 rounded-full"><div className="bg-amber-400 h-full rounded-full" style={{ width: '4.2%' }} /></div>
          </div>
          <div>
            <div className="flex items-center justify-between mb-1">
            ...
            <div className="w-full bg-gray-800 border border-gray-700 h-1.5 rounded-full"><div className="bg-emerald-9500 h-full rounded-full" style={{ width: '72%' }} /></div>
          </div>
        </div>
      </Card>
          ...
          <div className="space-y-4">
            <Card className="p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                <button className="text-[18px]  tracking-wider bg-gray-800 border border-gray-700 hover:bg-gray-200 text-white px-3 py-1.5 rounded font-bold transition-colors shadow-sm border border-gray-700">{t(`Εξέταση`, `Review`)}</button>
            ...
            <Card className="p-5 bg-gray-900 border-gray-700">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 text-[18px] border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-600 focus:outline-none bg-gray-800 border-gray-700 text-white">
                ...
                <Button className="w-full bg-gray-800 text-white border border-gray-700 shadow-[0_8px_30px_rgb(0,0,0,0.5)]">{t(`Εφαρμογή`, `Apply`)}</Button>
              </div>
            </Card>
          </div>
        </div>
