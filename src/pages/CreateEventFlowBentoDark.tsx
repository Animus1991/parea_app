              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-cyan-600 focus:border-transparent outline-none transition-all bg-gray-800 border-gray-700 text-white"
                  >
                    <option value="">
