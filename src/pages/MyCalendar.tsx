      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
        <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100">
          ...
          <div className="flex items-center gap-2">
             ...
             <button onClick={() => setCurrentDate(new Date())} className="px-3 py-1 text-xs font-bold bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200"></button>
            ...
            <div className="grid grid-cols-7 gap-2 mb-4">
              {days.map((day, i) => (
                <div key={i} className="text-center">
                  <div className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">{format(day, 'EEE')}</div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full">
                        <CheckCircle className="w-3 h-3" /></span>
                    </div>
        ...
        {view === 'month' && (
          <div className="p-4">
             <div className="text-center py-12 text-sm text-gray-500 font-medium flex flex-col items-center">
               <CalendarIcon className="w-12 h-[42px] text-gray-300 mb-3" /></div>
          </div>
        )}
      </div>
    </div>
