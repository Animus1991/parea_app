...
export default function GroupChatVibrant() {
  const { t } = useLanguage();
  ...
  const renderMessage = (index: number, msg: ChatMessage) => {
    ...
    if (isSystem) {
      return (
        ...
        >
          <span className="text-xs font-semibold tracking-tight capitalize text-[#111827] bg-[#F3F4F6] px-4 py-2 rounded-full shadow-sm max-w-sm text-center leading-relaxed">
            {msg.text}
          </span>
        </div>
      );
    ...
    return (
      ...
      >
        <span className="text-xs font-semibold tracking-tight capitalize text-black ml-1 mb-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            className={`max-w-[85%] sm:max-w-[75%] md:max-w-[65%] rounded-2xl px-4 py-2.5 text-base leading-relaxed relative ${
              isMe
                ? "bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white rounded-tr-sm shadow-sm"
        ...
        <span className="text-xs text-black mt-1 mr-1 font-medium tracking-wide">
    ...
    <div className="w-full h-full px-[5px] md:px-0 mx-auto max-w-[1200px]">
      <div className="w-full h-[calc(100dvh-5rem)] md:h-[calc(100dvh-6rem)] flex bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden relative">
              ...
              <>
                <div className="flex items-center gap-3 overflow-hidden">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs md:text-xs text-black tracking-wide font-bold truncate flex items-center gap-1.5 mt-0.5">
                ...
                <div className="flex items-center justify-end gap-1 sm:gap-2 shrink-0">
                  ...
                  <div className="hidden md:flex items-center gap-3 mr-2">
                    <select
                      ...
                      className="text-xs font-bold border border-gray-200 rounded-lg px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-fuchsia-500 bg-gray-50 text-black hover:bg-gray-100 cursor-pointer transition-colors max-w-[120px] truncate"
                    >
                      <option value="all">
                    ...
                    <div className="relative group">
                      <Search className="h-3.5 w-3.5 text-black absolute left-2.5 top-1/2 -translate-y-1/2 group-focus-within:text-fuchsia-500 transition-colors" />
                      <input
                        type="text"
                        placeholder={t("Αναζήτηση...", "Search...")}
                        value={searchQuery}
                        onChange={(e) => setSearchQuery(e.target.value)}
                        className="pl-8 pr-3 py-1.5 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-fuchsia-500 w-32 xl:w-48 bg-gray-50 focus:bg-white transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className={`transition-colors p-2 rounded-full ${showInfo ? "text-fuchsia-600 bg-fuchsia-50" : "text-black hover:text-[#111827] hover:bg-gray-100"}`}
                  >
            ...
            <div className="flex items-center gap-2 md:gap-3 max-w-4xl mx-auto w-full relative">
              ...
              <div className="flex-1 relative">
                ...
                <button
                  ...
                  className="absolute right-1.5 top-1/2 -translate-y-1/2 p-2 bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white rounded-full hover:bg-gray-800 disabled:opacity-40 disabled:hover:bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white transition-all shadow-sm"
                >
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-6 bg-gray-50/50">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  {event.tags && event.tags.length > 0 && (
                    <div className="flex gap-1.5 flex-wrap">
                      {event.tags.map((tag: string) => (
                        <span
                          key={tag}
                          className="bg-fuchsia-50 text-fuchsia-700 px-2.5 py-1 rounded-md text-xs font-bold tracking-wide border border-fuchsia-100"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <div className="space-y-2.5 text-sm font-medium text-black">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="font-bold text-sm capitalize tracking-tight text-[#111827]">
                  ...
                  <div className="flex items-center gap-2">
                    {isGroupAdmin && (
                      <button
                        ...
                        className="flex items-center gap-1 text-xs font-bold text-fuchsia-600 hover:text-fuchsia-700 bg-fuchsia-50 hover:bg-fuchsia-100 px-2 py-1 rounded border border-fuchsia-100 transition-colors"
                      >
                ...
                <div className="relative mb-4">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#111827] bg-gray-50 transition-all font-medium"
                  />
                </div>
                        ...
                        >
                          <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden shrink-0 relative group shadow-sm border border-gray-100">
                            {member.photoUrl ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center text-black font-bold text-xs bg-fuchsia-50 text-fuchsia-700">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <p
                                className={`text-xs font-bold tracking-wide truncate ${member.reliabilityScore >= 80 ? "text-emerald-600" : member.reliabilityScore >= 50 ? "text-blue-600" : "text-amber-600"}`}
                              >
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 space-y-5">
                <div>
                  <h4 className="font-bold text-sm capitalize tracking-tight text-[#111827] mb-3 flex items-center gap-1.5">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#111827] focus:ring-offset-2 ${isEphemeral ? "bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white" : "bg-gray-200"}`}
                    >
                ...
                <div className="pt-4 border-t border-gray-100">
                  ...
                  <div className="space-y-2">
                    ...
                    <button
                      onClick={() => setShowLocationConfigModal(true)}
                      className={`w-full flex items-center justify-between px-3 py-2.5 border rounded-lg transition-colors text-left ${isSharingLocation ? "bg-fuchsia-50 border-fuchsia-200 hover:bg-fuchsia-100" : "bg-gray-50 hover:bg-gray-100 border-gray-200"}`}
                    >
                      <div>
                        <p
                          className={`text-sm font-bold ${isSharingLocation ? "text-fuchsia-700" : "text-[#111827]"}`}
                        >
                          {isSharingLocation
                        ...
                        <p
                          className={`text-xs mt-0.5 ${isSharingLocation ? "text-fuchsia-600/80" : "text-black"}`}
                        >
                          {isSharingLocation
                      ...
                      <MapPin
                        className={`w-4 h-4 ${isSharingLocation ? "text-fuchsia-600" : "text-black"}`}
                      />
                    </button>
              ...
              <div className="space-y-2 pt-2">
                <button
                  ...
                  className="w-full py-2.5 px-4 text-xs font-bold tracking-wide text-red-600 bg-red-50/50 hover:bg-red-50 border border-red-100 rounded-lg transition-colors flex justify-center items-center gap-2"
                >
                  {t("Αναφορά Προβλήματος", "Report Safety Issue")}
                </button>
                <button
                  onClick={() => setShowLeaveModal(true)}
                  className="w-full py-2.5 px-4 text-xs font-bold tracking-wide text-black bg-white hover:bg-gray-50 border border-gray-200 rounded-lg transition-colors"
                >
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto custom-scrollbar border border-gray-100 animate-in zoom-in-95 duration-200">
              <div className="p-5 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white/95 backdrop-blur-sm z-10">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-fuchsia-50 rounded-full flex items-center justify-center text-fuchsia-600">
              ...
              <div className="p-5 space-y-6">
                {isSharingLocation && (
                  <div className="bg-fuchsia-50 border border-fuchsia-100 rounded-xl p-4 flex flex-col gap-3">
                ...
                <div className="space-y-3">
                  <h4 className="text-xs font-bold tracking-wide text-black">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <span
                        className={`text-sm font-bold ${locationConfig.precision === "approximate" ? "text-[#111827]" : "text-black"}`}
                      >
                        {t("Κατά προσέγγιση", "Approximate")}
                      </span>
                      <span className="text-xs text-black mt-1 leading-relaxed">
                        {t(
                    ...
                    >
                      <span
                        className={`text-sm font-bold ${locationConfig.precision === "exact" ? "text-[#111827]" : "text-black"}`}
                      >
                        {t("Ακριβής", "Exact")}
                      </span>
                      <span className="text-xs text-black mt-1 leading-relaxed">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-2">
                    {["organizer", "selected", "all"].map((option) => (
                      <label
                        key={option}
                        className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${locationConfig.shareWith === option ? "border-fuchsia-600 bg-fuchsia-50/30" : "border-gray-200 hover:bg-gray-50"}`}
                      >
              ...
              <div className="p-5 border-t border-gray-100 bg-gray-50/50">
                <button
                  ...
                  className="w-full px-4 py-3 text-sm font-bold text-white bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white hover:bg-gray-900 rounded-xl transition-all shadow-sm active:scale-[0.98]"
                >
                  {isSharingLocation
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6 text-center border border-gray-100 animate-in zoom-in-95 duration-200">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="text-xs font-bold text-fuchsia-600"
                >
                  {t("Αντιγραφή", "Copy")}
                </button>
              </div>
        ...
        {showDisableEphemeralModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6 text-center border border-gray-100 animate-in zoom-in-95 duration-200">
              <div className="w-12 h-12 bg-fuchsia-50 rounded-full flex items-center justify-center mx-auto mb-4 text-fuchsia-600">
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 border border-gray-100 animate-in zoom-in-95 duration-200">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 text-sm font-bold text-white bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white hover:bg-gray-900 rounded-xl transition-all shadow-sm hover:shadow-md"
                >
              ...
              <div className="flex flex-col gap-2.5">
                ...
                >
                  <input
                    ...
                    className="flex-1 w-full bg-gray-50 border border-gray-200 text-black text-sm rounded-xl px-4 py-3 focus:ring-2 focus:ring-fuchsia-500 focus:border-fuchsia-500 outline-none"
                    min="1"
                  />
                  <button
                    type="submit"
                ...
                {[
                  {
                    ...
                    color: "bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white hover:bg-gray-900",
                  },
                  {
              ...
              <div className="p-4 sm:p-5 bg-gray-50/50 border-b border-gray-100">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-fuchsia-600 bg-white transition-all shadow-sm font-medium"
                  />
                </div>
              </div>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden shrink-0 border border-gray-200">
                            {member.photoUrl ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center text-fuchsia-700 font-bold text-xs bg-fuchsia-50">
                                {member.name.substring(0, 2)}
                              </div>
                            )}
                          </div>
