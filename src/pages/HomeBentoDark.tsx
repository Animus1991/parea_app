  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-10 md:pb-0">
      ...
      <motion.div
        ...
        className="bg-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.5)] border border-gray-700 text-white p-6 md:p-10 rounded-[24px] shadow-sm relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-8"
      >
        <div className="relative z-10 flex-1">
          ...
          <div className="flex gap-3 items-center">
            ...
            <button
              ...
              className="hidden sm:flex items-center justify-center bg-gray-700 hover:bg-gray-600 border border-gray-600 text-white px-5 h-11 rounded-full text-xs font-bold transition-colors whitespace-nowrap"
            >
      ...
      <section className="bg-emerald-900/30 border border-emerald-800 rounded-xl p-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex gap-3 items-center">
          <div className="bg-gray-800 border-gray-700 text-white p-2 text-amber-500 rounded-full shadow-sm shrink-0">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {[
          ...
          <div
            key={step}
            className="bg-gray-800 border-gray-700 text-white p-4 rounded-xl border border-gray-800 shadow-sm flex flex-col items-center text-center"
          >
      ...
      <section className="space-y-4">
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`whitespace-nowrap px-3.5 py-1 rounded-full text-[12.75px] font-bold shadow-sm transition-colors tracking-wide ${
                  activeCategory === cat
                    ? "bg-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.5)] border border-gray-700 text-white"
                    : "bg-gray-800 border-gray-700 text-white border border-gray-700 text-white hover:text-white hover:bg-gray-700/60"
                }`}
              >
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 noscrollbar items-center flex-wrap">
          <select
            className="text-[12.73px] border border-gray-700 rounded-full shadow-sm bg-gray-800 border-gray-700 text-white hover:bg-gray-700/60 py-1.5 px-3 font-medium outline-none cursor-pointer"
            value={priceFilter}
            onChange={(e) =>
          ...
          <div className="relative ml-auto">
            <select
              className="text-[12.73px] border border-gray-700 rounded-full shadow-sm bg-gray-800 border-gray-700 text-white hover:bg-gray-700/60 py-1.5 pl-7 pr-3 font-medium outline-none cursor-pointer appearance-none"
              value={sortParam}
              onChange={(e) => {
      ...
      <section>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-4">
          ...
          <div className="flex bg-gray-800 border border-gray-700 p-0.5 rounded-lg w-fit">
            <button className="p-1.5 rounded-md transition-colors bg-gray-800 border-gray-700 text-white shadow-sm text-white" aria-label={t('Προβολή πλέγματος', 'Grid view')} title={t('Προβολή πλέγματος', 'Grid view')}>
