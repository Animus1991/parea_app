    ...
    <div className="space-y-6 md:space-y-8 pb-10 md:pb-0">
      ...
      <section className="space-y-4">
              ...
              <button
                ...
                className={`whitespace-nowrap px-3.5 py-1 rounded-full text-[12.75px] font-bold shadow-sm transition-colors tracking-wide ${
                  activeCategory === cat
                    ...
                    : "bg-gray-800 border-gray-700 text-white border border-gray-700 text-white hover:text-white hover:bg-gray-900"
                }`}
              >
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 noscrollbar items-center flex-wrap">
          <select
            className="text-[12.73px] border border-gray-700 rounded-full shadow-sm bg-gray-800 border-gray-700 text-white hover:bg-gray-900 py-1.5 px-3 font-medium outline-none cursor-pointer"
            value={priceFilter}
            onChange={(e) =>
          ...
          <div className="relative ml-auto">
            <select
              className="text-[12.73px] border border-gray-700 rounded-full shadow-sm bg-gray-800 border-gray-700 text-white hover:bg-gray-900 py-1.5 pl-7 pr-3 font-medium outline-none cursor-pointer appearance-none"
              value={sortParam}
              onChange={(e) => {
