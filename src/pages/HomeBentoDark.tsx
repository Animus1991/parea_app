  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-10 md:pb-0">
      ...
      <motion.div
        ...
        className="bg-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.5)] border border-gray-700 text-white p-6 md:p-10 rounded-[24px] shadow-sm relative overflow-hidden flex flex-col gap-4"
      >
