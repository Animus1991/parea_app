              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  <button key={star} onClick={() => setOverallRating(star)} className="p-2 hover:bg-gray-50 rounded-full transition-colors">
                    <Star className={`w-8 h-8 transition-colors ${star <= overallRating ? 'text-amber-400 fill-amber-400' : 'text-gray-300 hover:text-amber-400'}`} />
                  </button>
                ))}
              </div>
            </div>
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  <button key={`vibe-${star}`} onClick={() => setVibeRating(star)} className="p-2 hover:bg-gray-50 rounded-full transition-colors">
                    <Star className={`w-8 h-8 transition-colors ${star <= vibeRating ? 'text-cyan-400 fill-cyan-400' : 'text-gray-300 hover:text-cyan-400'}`} />
                  </button>
                ))}
              </div>
            </div>
