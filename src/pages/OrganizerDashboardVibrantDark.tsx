          ...
          <div className="p-4 bg-gray-800 grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="md:col-span-2 space-y-3">
               ...
               <div className="flex items-center justify-between p-3 bg-gray-800/70 rounded border border-gray-800">
                  ...
                  <div className="flex gap-2">
                    <button className="p-1.5 bg-gray-800 text-fuchsia-400 rounded shadow-sm border border-gray-700 hover:bg-fuchsia-900/30" aria-label={t('Μήνυμα ομάδας', 'Message group')} title={t('Μήνυμα ομάδας', 'Message group')}>
          ...
          <div className="p-4 bg-gray-800 grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="md:col-span-2 space-y-3">
               ...
               <div className="flex items-center justify-between p-3 bg-fuchsia-900/30 rounded border border-fuchsia-800">
                  ...
                  <div className="flex gap-2">
                    <button className="p-1.5 bg-gray-800 text-fuchsia-400 rounded shadow-sm border border-fuchsia-800 hover:bg-fuchsia-900/50 relative" aria-label={t('Μήνυμα ομάδας', 'Message group')} title={t('Μήνυμα ομάδας', 'Message group')}>
                      <MessageSquare className="w-3.5 h-3.5" />
