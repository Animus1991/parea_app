...
export default function SavedEventsBento() {
  const { t } = useLanguage();
          ...
          {savedEvents.map(event => (
            <Link key={event.id} to={`/events/${event.id}`} className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-all group flex flex-col">
              ...
              <div className="p-4 flex flex-col flex-1">
                ...
                <div className="mt-4 pt-3 border-t border-gray-100 flex items-center gap-1.5 text-[10px] font-bold text-indigo-600 tracking-wider">
