                ...
                <div className="flex items-center justify-end gap-1 sm:gap-2 shrink-0">
                  ...
                  <div className="hidden md:flex items-center gap-3 mr-2">
                    <select
                      ...
                      className="text-[11px] font-bold border border-gray-700 rounded-lg px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-emerald-9500 bg-gray-800/70 text-white hover:bg-gray-700 cursor-pointer transition-colors max-w-[120px] truncate"
                    >
                      <option value="all">
