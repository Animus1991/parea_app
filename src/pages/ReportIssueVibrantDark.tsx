...
export default function ReportIssueVibrantDark() {
    const { t } = useLanguage();
  ...
  return (
    <div className="max-w-full mx-auto space-y-6 animate-in slide-in-from-bottom-4 duration-500 fade-in pb-20 md:pb-0">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={() => navigate(-1)} className="text-white hover:text-white transition-colors rounded-full p-2 bg-gray-800 border border-gray-700 shadow-sm">
          <X className="w-5 h-5" />
        </button>
      </div>
      ...
      {step === 1 ? (
        ...
        <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-8 text-center">
          ...
          <button 
            onClick={() => navigate('/')}
            className="bg-gray-700 text-white px-5 py-2.5 rounded-full text-[13.5px] font-bold hover:bg-gray-200 transition-colors tracking-wider"
