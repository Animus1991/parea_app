...
export default function CreateEventFlowNeon() {
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div 
                    className="w-full h-40 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center text-black hover:bg-gray-50 hover:border-emerald-400 transition-colors cursor-pointer relative overflow-hidden"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-emerald-600 focus:border-transparent outline-none transition-all bg-white"
                  >
                    <option value="">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div
                      className={`border rounded-xl p-4 cursor-pointer transition-all ${visibility === "public" ? "border-emerald-600 bg-emerald-50 shadow-sm" : "border-gray-200 hover:border-emerald-200"}`}
                      onClick={() => setVisibility("public")}
                    >
                      <Globe
                        className={`w-5 h-5 mb-2 ${visibility === "public" ? "text-emerald-600" : "text-black"}`}
                      />
                    ...
                    <div
                      className={`border rounded-xl p-4 cursor-pointer transition-all ${visibility === "private" ? "border-emerald-600 bg-emerald-50 shadow-sm" : "border-gray-200 hover:border-emerald-200"}`}
                      onClick={() => setVisibility("private")}
                    >
                      <Lock
                        className={`w-5 h-5 mb-2 ${visibility === "private" ? "text-emerald-600" : "text-black"}`}
                      />
                      <h4 className="text-sm font-bold text-[#111827] mb-1">
                        {t("Ιδιωτική", "Private")}
                      </h4>
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  className="flex-[2] shadow-emerald-200 shadow-lg"
                >
