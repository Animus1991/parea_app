...
export default function GroupChatVibrantDark() {
  const { t } = useLanguage();
                  ...
                  <div className="hidden md:flex items-center gap-3 mr-2">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        value={searchQuery}
                        onChange={(e) => setSearchQuery(e.target.value)}
                        className="pl-8 pr-3 py-1.5 text-xs border border-gray-700 rounded-lg focus:outline-none focus:ring-1 focus:ring-fuchsia-9500 w-32 xl:w-48 bg-gray-800/70 focus:bg-gray-800 transition-all"
                      />
                    </div>
                  </div>
            ...
            <div className="bg-gray-800 rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto custom-scrollbar border border-gray-800 animate-in zoom-in-95 duration-200">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-2">
                    {["organizer", "selected", "all"].map((option) => (
                      <label
                        key={option}
                        className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${locationConfig.shareWith === option ? "border-fuchsia-600 bg-fuchsia-900/30/30" : "border-gray-700 hover:bg-gray-700/60"}`}
                      >
              ...
              <div className="p-5 border-t border-gray-800 bg-gray-900/50">
                <button
                  ...
                  className="w-full px-4 py-3 text-sm font-bold text-white bg-gradient-to-br from-red-900 via-rose-900 to-red-800 text-white hover:bg-gray-700/60 rounded-xl transition-all shadow-sm active:scale-[0.98]"
                >
                  {isSharingLocation
            ...
            <div className="bg-gray-800 rounded-2xl shadow-xl max-w-md w-full p-6 border border-gray-800 animate-in zoom-in-95 duration-200">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 text-sm font-bold text-white bg-gradient-to-br from-red-900 via-rose-900 to-red-800 text-white hover:bg-gray-700/60 rounded-xl transition-all shadow-sm hover:shadow-md"
                >
              ...
              <div className="flex flex-col gap-2.5">
                ...
                >
                  <input
                    ...
                    className="flex-1 w-full bg-gray-800/70 border border-gray-700 text-white text-sm rounded-xl px-4 py-3 focus:ring-2 focus:ring-fuchsia-9500 focus:border-fuchsia-9500 outline-none"
                    min="1"
                  />
                  <button
                    type="submit"
                ...
                {[
                  {
                    ...
                    color: "bg-gradient-to-br from-red-900 via-rose-900 to-red-800 text-white hover:bg-gray-700/60",
                  },
                  {
