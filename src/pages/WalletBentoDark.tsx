...
export default function WalletBentoDark() {
  const { t } = useLanguage();
  const transactions = [
    ...
    <div className="max-w-full mx-auto space-y-6 animate-in slide-in-from-bottom-4 duration-500 fade-in pb-20 md:pb-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-6 bg-cyan-600 text-white border-0 shadow-md">
          ...
          <Button className="w-full bg-gray-800 border-gray-700 text-white text-emerald-400 hover:bg-gray-800 border border-gray-700 border-0">
        ...
        <Card className="p-6 border border-gray-700 bg-gray-900 flex flex-col justify-center">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 bg-gray-800 border-gray-700 text-white shadow-sm border border-gray-700 rounded-full flex items-center justify-center text-white">
