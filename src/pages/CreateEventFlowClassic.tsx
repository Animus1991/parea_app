...
export default function CreateEventFlowClassic() {
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <Globe
                        className={`w-5 h-5 mb-2 ${visibility === "public" ? "text-cyan-600" : "text-gray-400"}`}
                      />
                    ...
                    >
                      <Lock
                        className={`w-5 h-5 mb-2 ${visibility === "private" ? "text-cyan-600" : "text-gray-400"}`}
                      />
                      <h4 className="text-sm font-bold text-[#111827] mb-1">
                        {t("Ιδιωτική", "Private")}
                      </h4>
