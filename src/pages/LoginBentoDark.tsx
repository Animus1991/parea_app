...
export default function LoginBentoDark() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-10 bg-gradient-to-br from-gray-950 via-gray-900 to-emerald-950">
      <LoginGuestHeroStrip variant="dark" accentClass="bg-indigo-900/40 text-indigo-400" />
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-gray-800 border-gray-700 text-white px-2 text-xs text-white tracking-wide">{t('Ή συνεχίστε με', 'Or continue with')}</span>
            </div>
          </div>
