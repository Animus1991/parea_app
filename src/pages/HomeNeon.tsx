  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-10 md:pb-0">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-violet-800 via-fuchsia-800 to-orange-700 text-white p-6 md:p-10 rounded-[24px] shadow-sm relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-8"
      >
        <div className="relative z-10 flex-1">
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-emerald-500/10 text-emerald-200 border border-emerald-400/20 hover:bg-emerald-500/20 rounded-xl font-bold text-[13.58px] transition-colors"
                ...
                <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-xl border border-gray-100 z-50 overflow-hidden">
                  ...
                  {searchSuggestions.map((s) => (
                    <button
                      ...
                      className="w-full text-left px-4 py-2.5 text-sm text-black hover:bg-emerald-50 hover:text-emerald-600 transition-colors font-medium flex items-center gap-2"
                    >
        ...
        {/* Decorative */}
        <div className="absolute right-0 top-0 w-[500px] h-[500px] bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-full blur-3xl -translate-y-1/4 translate-x-1/4 pointer-events-none" />
      </motion.div>

      {/* Pending Feedback Alert */}
      <section className="bg-emerald-50 border border-emerald-100 rounded-xl p-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex gap-3 items-center">
        ...
        <button
          ...
          className="text-[12.38px] tracking-wider font-bold bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white px-4 py-2 rounded-full whitespace-nowrap hover:bg-black w-full sm:w-auto shadow-sm transition-colors"
        >
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {[
          ...
          >
            <div className="w-8 h-8 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center font-bold text-xs mb-2.5">
              {step}
            </div>
            ...
            <button
              ...
              className={`whitespace-nowrap px-3 py-1 rounded-full text-[11.82px] font-bold transition-colors border ${
                tagFilter === tag
                  ...
                  : "bg-white border-gray-200 text-black hover:border-emerald-300 hover:text-emerald-600"
              }`}
            >
