  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-10 md:pb-0">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-violet-800 via-fuchsia-800 to-orange-700 text-white p-6 md:p-10 rounded-[24px] shadow-sm relative overflow-hidden flex flex-col gap-4"
      >
        <HomeHeroModeBar className="relative z-10" />
        <div className="relative z-10 flex-1 w-full">
          <div className={cn("text-orange-200 mb-4", HOME_TYPO.heroBadge)}>
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className={cn("flex items-center gap-2 px-5 py-2.5 bg-emerald-500/10 text-emerald-200 border border-emerald-400/20 hover:bg-emerald-500/20 rounded-xl transition-colors", HOME_TYPO.heroMapBtn)}
