          ...
          <Card key={event.id} className="rounded-xl p-4 sm:p-5 border border-emerald-800 flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="mt-auto pt-4 border-t border-gray-800 flex gap-2">
                ...
                <button onClick={() => navigate(`/events/${event.id}`)} className="bg-gray-800 border-gray-700 text-white border border-gray-700 hover:bg-gray-900 text-white px-4 py-2 rounded-lg text-[12.825px] font-bold transition-colors">
