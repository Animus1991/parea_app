...
const GroupImage = ({
  ...
  return error ? (
    <div
      className={`flex items-center justify-center bg-emerald-900/30 text-emerald-300 ${className}`}
    >
...
export default function NearbyGroupsNeonDark() {
    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#e5e3df] z-0 flex items-center justify-center">
          ...
          {localGroups.map((group, idx) => {
            ...
            return (
              ...
              >
                ...
                {isSelected && (
                  <div className="absolute bottom-full mb-2 bg-gray-800 rounded-lg shadow-xl border border-gray-700 p-3 w-48 z-20">
                    <button
                    ...
                    <div className="font-bold text-[10px] text-white tracking-widest mb-1">
                      {group.category}
                    </div>
                    <GroupImage
                      src={group.imageUrl ?? ""}
                    ...
                    <button
                      className="w-full bg-gradient-to-br from-emerald-900 via-teal-900 to-emerald-800 text-white text-[10px] font-bold tracking-wide py-1.5 rounded-md hover:bg-black transition-colors"
          ...
          <div className="absolute top-[80px] left-[50%] transform -translate-x-1/2 bg-gray-800/90 backdrop-blur text-white text-xs px-3 py-1.5 rounded-full border border-gray-700 shadow-sm z-10">
            {t(
        ...
        <div className="absolute top-4 left-4 right-4 z-10 flex gap-2 pointer-events-none">
          <div className="relative flex-1 max-w-sm pointer-events-auto">
            ...
            <input
              ...
              className="w-full h-11 pl-10 pr-4 rounded-xl border-0 bg-gray-800/95 backdrop-blur shadow-lg focus:outline-none focus:ring-2 focus:ring-emerald-600 text-sm font-medium"
            />
          </div>
          <button className="h-11 px-4 bg-gray-800/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-white hover:text-emerald-400 transition-colors pointer-events-auto">
            <SlidersHorizontal className="h-5 w-5" />
          </button>
        </div>

        {/* Slide-up Panel for Mobile, Sidebar for Desktop */}
        <div className="absolute bottom-0 left-0 right-0 md:top-0 md:bottom-0 md:right-auto md:w-96 bg-gray-800 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] md:shadow-[10px_0_40px_rgba(0,0,0,0.1)] z-20 flex flex-col rounded-t-3xl md:rounded-none transition-transform duration-300 transform translate-y-0 max-h-[60vh] md:max-h-full">
          ...
          <div className="overflow-y-auto flex-1 p-4 space-y-3 text-left">
            {localGroups.map((group, idx) => (
              <div
                key={idx}
                className={`p-3 border ${selectedEventId === group.id ? "border-emerald-9500 shadow-md ring-1 ring-emerald-9500" : "border-gray-800"} rounded-xl hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer group flex gap-3 bg-gray-800`}
                onClick={() => {
                  setSelectedEventId(group.id);
              ...
              >
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <div className="flex items-center text-[10px] font-bold text-emerald-400 bg-emerald-900/30 px-1.5 py-0.5 rounded">
            ...
            <div className="p-6 text-center border border-dashed border-gray-700 rounded-xl bg-gray-800/70">
              ...
              <button
                ...
                className="text-xs font-bold text-white bg-gradient-to-br from-emerald-900 via-teal-900 to-emerald-800 text-white px-4 py-2 rounded-full hover:bg-gray-800 transition-colors"
              >
                Set radius to 15km
              </button>
            </div>
  ...
  return (
    ...
    >
        ...
        <ErrorBoundary
          fallback={
            <div className="w-full h-full flex items-center justify-center bg-[#e5e3df] p-8 text-center">
              <div className="bg-gray-800 p-6 rounded-xl shadow-lg max-w-sm border border-emerald-900">
                <AlertTriangle className="w-10 h-10 text-emerald-9500 mx-auto mb-3" />
              ...
              >
                <Popup>
                  ...
                  >
                    ...
                    <p className="text-[10px] text-white mb-2 truncate">
                      <MapPin className="inline w-3 h-3 mr-0.5" />{" "}
                      {group.locationArea}
                    </p>
                    <button className="w-full bg-gradient-to-br from-emerald-900 via-teal-900 to-emerald-800 text-white text-[10px] font-bold tracking-wide py-1.5 rounded-md hover:bg-black transition-colors">
                      View Event
                    </button>
                  </div>
                </Popup>
      ...
      >
        {!isMapFullscreen && (
          <div className="relative flex-1 max-w-sm pointer-events-auto shadow-lg bg-gray-800/95 backdrop-blur rounded-xl">
            <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-white" />
            <input
              type="text"
              placeholder={t('��������� �������� �������� � ������...', 'Search nearby areas or groups...')}
        ...
        {!isMapFullscreen && (
          <button
            onClick={() => alert(t("�� ������ ���������� �������� �������", "Search filters coming soon"))}
            className="h-11 px-4 bg-gray-800/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-white hover:text-emerald-400 transition-colors pointer-events-auto shrink-0"
        ...
        <button
          ...
          className="h-11 px-4 bg-gray-800/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-emerald-400 hover:text-emerald-400 transition-colors pointer-events-auto shrink-0 ml-auto"
          title={t('���������� ����������', 'Locate Me')}
        ...
        {locationError && (
          <div className="absolute bottom-20 left-1/2 -translate-x-1/2 bg-emerald-600 text-white text-xs font-bold px-4 py-2 rounded-full shadow-lg pointer-events-none whitespace-nowrap z-50">
            {locationError}
          </div>
        )}
        <button
          onClick={() => setIsMapFullscreen(!isMapFullscreen)}
          className="h-11 px-4 bg-gradient-to-br from-emerald-900 via-teal-900 to-emerald-800 text-white rounded-xl shadow-lg flex items-center justify-center hover:bg-black transition-colors pointer-events-auto shrink-0"
          title={isMapFullscreen ? t('������ ��� ����� �����', 'Exit Fullscreen') : t('������ ����� �����', 'Fullscreen Map')}
          aria-label={isMapFullscreen ? t('������ ��� ����� �����', 'Exit Fullscreen') : t('������ ����� �����', 'Fullscreen Map')}
        >
          {isMapFullscreen ? (
      ...
      {/* Slide-up Panel for Mobile, Sidebar for Desktop */}
      <div
        className={`absolute bottom-0 left-0 right-0 md:top-0 md:bottom-0 md:right-auto bg-gray-800 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] md:shadow-[10px_0_40px_rgba(0,0,0,0.1)] z-20 flex flex-col rounded-t-3xl md:rounded-none transition-transform duration-300 transform translate-y-0 dynamic-sidebar-width ${isMapFullscreen ? "translate-y-full md:-translate-x-full" : isPanelExpanded ? "top-0 md:h-full" : "max-h-[60vh] md:max-h-full"} ${isDragging ? "transition-none" : ""}`}
      >
        ...
        >
          <div className="w-12 h-1.5 bg-gray-300 hover:bg-gray-400 rounded-full flex items-center justify-center relative">
            <span className="absolute -top-3 text-white">
              {isPanelExpanded ? (
        ...
        <div className="overflow-y-auto flex-1 p-4 space-y-3 text-left">
          {localGroups.map((group, idx) => (
            <div
              key={idx}
              className="p-3 border border-gray-800 rounded-xl hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer group flex gap-3 bg-gray-800"
              onClick={() => navigate(`/events/${group.id}`)}
            >
              <div className="w-16 h-16 rounded-lg bg-gray-700 overflow-hidden shrink-0">
                <GroupImage
