      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-2 mt-6">
          {Array.from({ length: totalSteps }).map((_, i) => (
            <motion.div
              key={i}
              className={`h-1.5 flex-1 rounded-full ${i < step ? "bg-emerald-600" : "bg-gray-200"}`}
              initial={false}
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div 
                    className="w-full h-40 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center text-white hover:bg-gray-700/60 hover:border-emerald-400 transition-colors cursor-pointer relative overflow-hidden"
                  ...
                  {imagePreview && (
                     <button onClick={() => setImagePreview(null)} className="text-[11px] text-emerald-9500 font-bold capitalize tracking-tight mt-2 hover:underline">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-emerald-600 focus:border-transparent outline-none transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-emerald-600 focus:border-transparent outline-none transition-all bg-gray-800"
                  >
                    <option value="">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-emerald-600 focus:border-transparent outline-none transition-all resize-none"
                  ></textarea>
                </div>
              </div>
                ...
                <div>
                  ...
                  {duration === "custom" && (
                     <input 
                       ...
                       className="w-full border border-gray-300 rounded-lg px-4 py-2 mt-2 text-sm focus:ring-2 focus:ring-emerald-600 outline-none"
                       onChange={(e) => setDuration(e.target.value)}
                     />
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="relative mb-2">
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-lg pl-10 pr-4 py-2 text-sm focus:ring-2 focus:ring-emerald-600 focus:border-transparent outline-none transition-all"
                    />
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div
                      className={`border rounded-xl p-4 cursor-pointer transition-all ${visibility === "public" ? "border-emerald-600 bg-emerald-900/30 shadow-sm" : "border-gray-700 hover:border-emerald-800"}`}
                      onClick={() => setVisibility("public")}
                    >
                      <Globe
                        className={`w-5 h-5 mb-2 ${visibility === "public" ? "text-emerald-400" : "text-white"}`}
                      />
                    ...
                    <div
                      className={`border rounded-xl p-4 cursor-pointer transition-all ${visibility === "private" ? "border-emerald-600 bg-emerald-900/30 shadow-sm" : "border-gray-700 hover:border-emerald-800"}`}
                      onClick={() => setVisibility("private")}
                    >
                      <Lock
                        className={`w-5 h-5 mb-2 ${visibility === "private" ? "text-emerald-400" : "text-white"}`}
                      />
                      <h4 className="text-sm font-bold text-white mb-1">
                        {t("Ιδιωτική", "Private")}
                      </h4>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-20 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-emerald-600 focus:border-transparent outline-none text-center"
                    />
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  className="flex-[2] shadow-emerald-800 shadow-lg"
                >
