            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div 
                    className="w-full h-40 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center text-white hover:bg-gray-900 hover:border-emerald-400 transition-colors cursor-pointer relative overflow-hidden"
