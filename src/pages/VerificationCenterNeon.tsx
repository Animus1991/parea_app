...
export default function VerificationCenterNeon() {
    const { t } = useLanguage();
  return (
    <div className="max-w-full mx-auto space-y-6 animate-in slide-in-from-bottom-4 duration-500 fade-in pb-20 md:pb-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="bg-emerald-50 border border-emerald-100 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[13.8px] font-bold text-emerald-900">Email</span>
            </div>
            ...
            <span className="mt-2 inline-block text-[11.2px] font-bold text-emerald-600 bg-white px-2 py-0.5 rounded-full">~1 {t(`λεπτό`, `min`)}</span>
          </div>
      ...
      <Card className="p-4 flex items-center gap-4">
        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-500 flex items-center justify-center text-white font-black text-[18px] shrink-0">72%</div>
