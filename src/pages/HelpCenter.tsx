...
export default function HelpCenter() {
  ...
  const articles = [
    { id: 1, title: 'How to report a no-show', category: 'Trust & Safety' },
    { id: 2, title: 'Getting a refund for a canceled event', category: 'Payments' },
    { id: 3, title: 'Tips for hosting your first meetup', category: 'Organizers' },
    { id: 4, title: 'Changing your notification preferences', category: 'Account' },
  ];
  ...
  return (
    <div className="max-w-full mx-auto space-y-6 animate-in slide-in-from-bottom-4 duration-500 fade-in pb-20 md:pb-0">
      <div className="bg-indigo-600 text-white rounded-2xl p-8 mb-8 text-center shadow-lg relative overflow-hidden">
        ...
        <h1 className="text-2xl md:text-3xl font-black mb-2 relative z-10">How can we help?</h1>
        <p className="text-indigo-100 text-sm mb-6 relative z-10">Search our knowledge base or get in touch with our team.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-6 text-center hover:shadow-md transition-shadow cursor-pointer border border-transparent hover:border-indigo-100">
          ...
          <h3 className="font-bold text-[#111827] mb-1">Guides & Tutorials</h3>
          <p className="text-xs text-gray-500">Learn how to make the most out of Nakamas.</p>
        </Card>
        ...
        <Card className="p-6 text-center hover:shadow-md transition-shadow cursor-pointer border border-transparent hover:border-indigo-100">
          ...
          <h3 className="font-bold text-[#111827] mb-1">Policies</h3>
          <p className="text-xs text-gray-500">Read our terms, conditions, and community guidelines.</p>
        </Card>
        ...
        <Card className="p-6 text-center hover:shadow-md transition-shadow cursor-pointer border border-transparent hover:border-indigo-100">
          ...
          <h3 className="font-bold text-[#111827] mb-1">Contact Support</h3>
          <p className="text-xs text-gray-500">Can't find the answer? Reach out to our team.</p>
        </Card>
      </div>

      <div className="pt-8">
        <h2 className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-4 px-1">Frequently Asked Questions</h2>
