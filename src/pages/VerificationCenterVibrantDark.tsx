...
export default function VerificationCenterVibrantDark() {
    const { t } = useLanguage();
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card className="p-5 md:col-span-2">
           <div className="flex items-start justify-between border-b border-gray-800 pb-4 mb-4">
              ...
              <span className="bg-gray-700 text-white text-[10.90125px] font-bold px-2 py-0.5 rounded-full tracking-wide">{t(`Προχωρημένο`, `Advanced`)}</span>
           </div>
      ...
      <Card className="p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div className="bg-purple-50 border border-purple-100 rounded-lg p-3">
            ...
            <span className="mt-2 inline-block text-[11.2px] font-bold text--400 bg-gray-800 px-2 py-0.5 rounded-full">~2 {t(`λεπτά`, `min`)}</span>
          </div>
          <div className="bg-amber-50 border border-amber-100 rounded-lg p-3">
            ...
            <span className="mt-2 inline-block text-[11.2px] font-bold text-amber-600 bg-gray-800 px-2 py-0.5 rounded-full">~5 {t(`λεπτά`, `min`)}</span>
          </div>
        </div>
      </Card>
