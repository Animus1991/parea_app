          ...
          {step === 1 && (
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-[13px] font-semibold text-gray-700 capitalize tracking-tight mb-2">
                    {t("Εικόνα Εκδήλωσης", "Event Image")}
                  </label>
                  <div 
                    className="w-full h-40 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center text-gray-500 hover:bg-gray-50 hover:border-indigo-400 transition-colors cursor-pointer relative overflow-hidden"
                  ...
                  >
                    {imagePreview ? (
                       ...
                       <>
                         ...
                         <span className="text-sm font-bold text-gray-600 block">{t('Ανέβασμα Εικόνας', 'Upload Image')}</span>
                         <span className="text-[11px] text-gray-500 mt-1 capitalize tracking-tight">{t('JPG, PNG έως 5MB', 'JPG, PNG up to 5MB')}</span>
                       </>
                    )}
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none transition-all bg-white"
                  >
                    <option value="">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none transition-all resize-none"
                  ></textarea>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[13px] font-semibold text-gray-700 capitalize tracking-tight mb-2 flex items-center gap-1.5">
                ...
                <div>
                  ...
                  {duration === "custom" && (
                     <input 
                       ...
                       className="w-full border border-gray-300 rounded-lg px-4 py-2 mt-2 text-sm focus:ring-2 focus:ring-indigo-600 outline-none"
                       onChange={(e) => setDuration(e.target.value)}
                     />
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="relative mb-2">
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-lg pl-10 pr-4 py-2 text-sm focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none transition-all"
                    />
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-[13px] font-semibold text-gray-700 capitalize tracking-tight mb-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <Globe
                        className={`w-5 h-5 mb-2 ${visibility === "public" ? "text-indigo-600" : "text-gray-400"}`}
                      />
                    ...
                    >
                      <Lock
                        className={`w-5 h-5 mb-2 ${visibility === "private" ? "text-indigo-600" : "text-gray-400"}`}
                      />
                      <h4 className="text-sm font-bold text-[#111827] mb-1">
                        {t("Ιδιωτική", "Private")}
                      </h4>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-20 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none text-center"
                    />
