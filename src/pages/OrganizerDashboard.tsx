      ...
      <div>
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 noscrollbar">
          {[
            ...
            <button key={tpl.label} onClick={() => navigate('/create')} className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-gray-200 bg-white hover:bg-cyan-50 hover:border-cyan-200 transition-colors text-[12.5px] font-bold text-gray-700">
