      ...
      <div className="bg-gray-800 border-gray-700 text-white rounded-2xl border border-gray-700 overflow-hidden shadow-sm">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
          ...
          <div className="flex items-center gap-2">
            <button onClick={prevPeriod} className="p-1.5 hover:bg-gray-800 border border-gray-700 rounded-full transition-colors">
            ...
            <button onClick={nextPeriod} className="p-1.5 hover:bg-gray-800 border border-gray-700 rounded-full transition-colors">
