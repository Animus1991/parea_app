...
const GroupImage = ({
  ...
  return error ? (
    <div
      className={`flex items-center justify-center bg-emerald-50 text-emerald-300 ${className}`}
    >
...
export default function NearbyGroupsNeon() {
              ...
              >
                ...
                {isSelected && (
                  <div className="absolute bottom-full mb-2 bg-white rounded-lg shadow-xl border border-gray-200 p-3 w-48 z-20">
                    ...
                    <button
                      className="w-full bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white text-[10px] font-bold tracking-wide py-1.5 rounded-md hover:bg-black transition-colors"
        ...
        <div className="absolute top-4 left-4 right-4 z-10 flex gap-2 pointer-events-none">
          <div className="relative flex-1 max-w-sm pointer-events-auto">
            ...
            <input
              ...
              className="w-full h-11 pl-10 pr-4 rounded-xl border-0 bg-white/95 backdrop-blur shadow-lg focus:outline-none focus:ring-2 focus:ring-emerald-600 text-sm font-medium"
            />
          </div>
          <button className="h-11 px-4 bg-white/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-black hover:text-emerald-600 transition-colors pointer-events-auto">
        ...
        <div className="absolute bottom-0 left-0 right-0 md:top-0 md:bottom-0 md:right-auto md:w-96 bg-white shadow-[0_-10px_40px_rgba(0,0,0,0.1)] md:shadow-[10px_0_40px_rgba(0,0,0,0.1)] z-20 flex flex-col rounded-t-3xl md:rounded-none transition-transform duration-300 transform translate-y-0 max-h-[60vh] md:max-h-full">
          ...
          <div className="overflow-y-auto flex-1 p-4 space-y-3 text-left">
            {localGroups.map((group, idx) => (
              <div
                key={idx}
                className={`p-3 border ${selectedEventId === group.id ? "border-emerald-500 shadow-md ring-1 ring-emerald-500" : "border-gray-100"} rounded-xl hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer group flex gap-3 bg-white`}
                onClick={() => {
                  setSelectedEventId(group.id);
              ...
              >
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                  <div>
                    <h3 className="font-bold text-sm text-[#111827] line-clamp-1 group-hover:text-emerald-600 transition-colors">
                      {group.title}
                    </h3>
            ...
            <div className="p-6 text-center border border-dashed border-gray-200 rounded-xl bg-gray-50">
              ...
              <button
                ...
                className="text-xs font-bold text-white bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white px-4 py-2 rounded-full hover:bg-black transition-colors"
              >
                Set radius to 15km
              </button>
            </div>
  ...
  return (
    ...
    >
              ...
              >
                <Popup>
                  ...
                  >
                    ...
                    <button className="w-full bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white text-[10px] font-bold tracking-wide py-1.5 rounded-md hover:bg-black transition-colors">
                      View Event
                    </button>
                  </div>
                </Popup>
      ...
      >
        ...
        {!isMapFullscreen && (
          <button
            ...
            className="h-11 px-4 bg-white/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-black hover:text-emerald-600 transition-colors pointer-events-auto shrink-0"
        ...
        <button
          ...
          className="h-11 px-4 bg-white/95 backdrop-blur rounded-xl shadow-lg flex items-center justify-center text-emerald-600 hover:text-emerald-800 transition-colors pointer-events-auto shrink-0 ml-auto"
          title={t('���������� ����������', 'Locate Me')}
        ...
        <button
          ...
          className="h-11 px-4 bg-gradient-to-br from-violet-600 via-fuchsia-600 to-orange-500 text-white rounded-xl shadow-lg flex items-center justify-center hover:bg-black transition-colors pointer-events-auto shrink-0"
      ...
      >
        ...
        />
        <div
          className="absolute top-0 bottom-0 -right-2 w-4 cursor-ew-resize hover:bg-emerald-500/10 transition-all hidden md:block z-50 pointer-events-auto"
        ...
        <div className="overflow-y-auto flex-1 p-4 space-y-3 text-left">
          {localGroups.map((group, idx) => (
            <div
              key={idx}
              className="p-3 border border-gray-100 rounded-xl hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer group flex gap-3 bg-white"
              onClick={() => navigate(`/events/${group.id}`)}
            >
              <div className="w-16 h-16 rounded-lg bg-gray-100 overflow-hidden shrink-0">
                <GroupImage
