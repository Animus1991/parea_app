  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <EventDetailPageContent event={event} accent="bento" className="mt-4" />
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:gap-8 md:grid-cols-5 lg:grid-cols-3">
        ...
        <div className="space-y-6 md:space-y-8 md:col-span-3 lg:col-span-2">
          <section className="space-y-4 text-[13px] text-[#111827] leading-relaxed bg-white rounded-2xl border border-gray-100 p-5 md:p-6 shadow-soft">
             ...
             <EventMap event={event} accent="bento" />
             <EventDetailAboutSection event={event} accent="bento" />
             <EventDetailOrganizerSection organizer={organizer} accent="bento" />
             <EventDetailSafetySection event={event} accent="bento" />
             <EventDetailAdventureSection event={event} accent="bento" />
          </section>
          <EventDetailReliabilityNote event={event} accent="bento" />
        </div>
        ...
        <div className="space-y-6 md:col-span-2 lg:col-span-1">
          <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-soft sticky top-24">
            <EventDetailBuddySeekPanel event={event} accent="bento" />
