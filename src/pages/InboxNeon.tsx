...
export default function InboxNeon() {
    const { t } = useLanguage();
      ...
      <div className="shrink-0 mb-6">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 text-[16.2px] font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500"
          />
        </div>
          ...
          filteredChats.map(chat => (
            ...
            >
              <div className="relative shrink-0">
                ...
                {chat.isPinned && <Pin className="absolute -top-1 -right-1 w-3.5 h-3.5 text-emerald-600 fill-emerald-600" />}
                {chat.online > 0 && (
              ...
              <div className="flex-1 min-w-0">
                ...
                {chat.isTyping ? (
                  <p className="text-[13.5px] text-emerald-600 font-medium mt-0.5 flex items-center gap-1">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {chat.timeRemaining && <span className="text-[11.25px] text-emerald-600 font-bold flex items-center gap-0.5"><Clock className="w-3 h-3" />{chat.timeRemaining}</span>}
                </div>
              </div>
              {chat.unread > 0 && (
