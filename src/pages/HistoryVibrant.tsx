...
export default function HistoryVibrant() {
    const { t } = useLanguage();
    ...
    <div className="max-w-full mx-auto space-y-6 animate-in slide-in-from-bottom-4 duration-500 fade-in pb-20 md:pb-0">
      ...
      <div className="space-y-3">
        {pastEvents.map((event) => (
          <Card key={event.id} className="p-4 hover:border-fuchsia-200 transition-colors cursor-pointer" onClick={() => navigate(`/history/feedback/${event.id}`)}>
