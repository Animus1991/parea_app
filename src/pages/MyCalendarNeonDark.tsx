...
export default function MyCalendarNeonDark() {
      ...
      <div className="bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden shadow-sm">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
          ...
          <div className="flex items-center gap-2">
            <button onClick={prevPeriod} className="p-1.5 hover:bg-gray-700 rounded-full transition-colors" aria-label={t('Προηγούμενη περίοδος', 'Previous period')}>
            ...
            <button onClick={nextPeriod} className="p-1.5 hover:bg-gray-700 rounded-full transition-colors" aria-label={t('Επόμενη περίοδος', 'Next period')}>
