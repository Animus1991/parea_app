  ...
  return (
    <div className="max-w-full mx-auto space-y-6 animate-in slide-in-from-bottom-4 duration-500 fade-in pb-20 md:pb-0">
      ...
      <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex gap-4 mt-6">
        ...
        <div>
          <h2 className="font-bold text-emerald-900 text-sm"></h2>
          <p className="text-xs text-emerald-700 mt-1 mb-3"></p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
           ...
           <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                 ...
                 <div>
                    ...
                    <p className="text-[10px] text-gray-500 uppercase font-bold tracking-wider mt-0.5"></p>
                 </div>
              </div>
        ...
        <Card className="p-5">
           <div className="flex items-start justify-between border-b border-gray-100 pb-4 mb-4">
              <div className="flex items-center gap-3">
                 ...
                 <div>
                    <h3 className="font-bold text-sm text-[#111827]"></h3>
                    <p className="text-[10px] text-gray-400 uppercase font-bold tracking-wider mt-0.5"></p>
                 </div>
              </div>
           </div>
        ...
        <Card className="p-5 md:col-span-2">
           <div className="flex items-start justify-between border-b border-gray-100 pb-4 mb-4">
              ...
              <span className="bg-gray-100 text-gray-600 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider"></span>
           </div>
           <p className="text-sm text-gray-500 mb-4 max-w-xl"></p>
           <div className="bg-gray-50 p-4 rounded-lg flex flex-col sm:flex-row items-center justify-between gap-4 border border-dashed border-gray-200">
             <div className="flex gap-3 text-xs text-gray-500 font-medium">
                <span className="flex items-center gap-1"><ShieldCheck className="w-4 h-4"/></span>
                <span className="flex items-center gap-1"><UserCheck className="w-4 h-4"/></span>
             </div>
             <Button size="sm" className="w-full sm:w-auto shrink-0 shadow-sm"></Button>
           </div>
        </Card>
      </div>
    </div>
