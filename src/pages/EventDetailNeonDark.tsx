...
function Group({ group, event, navigate }: { group: import('../types').Group; event: import('../types').Event; navigate: import('react-router-dom').NavigateFunction }) {
  return <EventDetailGroupCard group={group} event={event} navigate={navigate} accent="neon" darkSurface />;
}
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <EventDetailPageContent event={event} accent="neon" darkSurface className="mt-4" />
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:gap-8 md:grid-cols-5 lg:grid-cols-3">
        ...
        <div className="space-y-6 md:space-y-8 md:col-span-3 lg:col-span-2">
          <section className="space-y-4 text-[13px] text-white leading-relaxed bg-gray-800 rounded-2xl border border-gray-700 p-5 md:p-6 shadow-soft">
             <EventDetailMetaSection event={event} accent="neon" darkSurface />
             <EventMap event={event} accent="neon" darkSurface />
             <EventDetailAboutSection event={event} accent="neon" darkSurface />
             <EventDetailOrganizerSection organizer={organizer} accent="neon" darkSurface />
             <EventDetailSafetySection event={event} accent="neon" darkSurface />
             <EventDetailAdventureSection event={event} accent="neon" darkSurface />
          </section>
          <EventDetailReliabilityNote event={event} accent="neon" darkSurface />
        </div>
        ...
        <div className="space-y-6 md:col-span-2 lg:col-span-1">
          <div className="rounded-2xl border border-gray-700 bg-gray-800 p-6 shadow-soft sticky top-24">
            <EventDetailBuddySeekPanel event={event} accent="neon" darkSurface />
