  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-10 md:pb-0">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-gray-950 via-emerald-950 to-gray-950 text-white p-6 md:p-10 rounded-[24px] shadow-sm relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-8"
      >
        <div className="relative z-10 flex-1">
          <div className="text-emerald-300 text-[14.21px] font-bold tracking-wide mb-4">
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-emerald-500/10 text-emerald-300 border border-emerald-500/20 hover:bg-emerald-500/20 rounded-xl font-bold text-[13.58px] transition-colors"
