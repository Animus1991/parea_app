...
export default function GroupChatNeon() {
  const { t } = useLanguage();
                ...
                <div className="flex items-center justify-end gap-1 sm:gap-2 shrink-0">
                  ...
                  <div className="hidden md:flex items-center gap-3 mr-2">
                    <select
                      ...
                      className="text-xs font-bold border border-gray-200 rounded-lg px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-emerald-500 bg-gray-50 text-black hover:bg-gray-100 cursor-pointer transition-colors max-w-[120px] truncate"
                    >
                      <option value="all">
                    ...
                    <div className="relative group">
                      <Search className="h-3.5 w-3.5 text-black absolute left-2.5 top-1/2 -translate-y-1/2 group-focus-within:text-emerald-500 transition-colors" />
                      <input
                        type="text"
                        placeholder={t("Αναζήτηση...", "Search...")}
                        value={searchQuery}
                        onChange={(e) => setSearchQuery(e.target.value)}
                        className="pl-8 pr-3 py-1.5 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-emerald-500 w-32 xl:w-48 bg-gray-50 focus:bg-white transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className={`transition-colors p-2 rounded-full ${showInfo ? "text-emerald-600 bg-emerald-50" : "text-black hover:text-[#111827] hover:bg-gray-100"}`}
                  >
                  ...
                  {event.tags && event.tags.length > 0 && (
                    <div className="flex gap-1.5 flex-wrap">
                      {event.tags.map((tag: string) => (
                        <span
                          key={tag}
                          className="bg-emerald-50 text-emerald-700 px-2.5 py-1 rounded-md text-xs font-bold tracking-wide border border-emerald-100"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <div className="flex items-center gap-2">
                    {isGroupAdmin && (
                      <button
                        ...
                        className="flex items-center gap-1 text-xs font-bold text-emerald-600 hover:text-emerald-700 bg-emerald-50 hover:bg-emerald-100 px-2 py-1 rounded border border-emerald-100 transition-colors"
                      >
                        ...
                        >
                          <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden shrink-0 relative group shadow-sm border border-gray-100">
                            {member.photoUrl ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center text-black font-bold text-xs bg-emerald-50 text-emerald-700">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 space-y-5">
                ...
                <div className="pt-4 border-t border-gray-100">
                  ...
                  <div className="space-y-2">
                    ...
                    <button
                      onClick={() => setShowLocationConfigModal(true)}
                      className={`w-full flex items-center justify-between px-3 py-2.5 border rounded-lg transition-colors text-left ${isSharingLocation ? "bg-emerald-50 border-emerald-200 hover:bg-emerald-100" : "bg-gray-50 hover:bg-gray-100 border-gray-200"}`}
                    >
                      <div>
                        <p
                          className={`text-sm font-bold ${isSharingLocation ? "text-emerald-700" : "text-[#111827]"}`}
                        >
                          {isSharingLocation
                        ...
                        <p
                          className={`text-xs mt-0.5 ${isSharingLocation ? "text-emerald-600/80" : "text-black"}`}
                        >
                          {isSharingLocation
                      ...
                      <MapPin
                        className={`w-4 h-4 ${isSharingLocation ? "text-emerald-600" : "text-black"}`}
                      />
                    </button>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-2">
                    {["organizer", "selected", "all"].map((option) => (
                      <label
                        key={option}
                        className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${locationConfig.shareWith === option ? "border-emerald-600 bg-emerald-50/30" : "border-gray-200 hover:bg-gray-50"}`}
                      >
              ...
              <div className="flex flex-col gap-2.5">
                ...
                >
                  <input
                    ...
                    className="flex-1 w-full bg-gray-50 border border-gray-200 text-black text-sm rounded-xl px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none"
                    min="1"
                  />
                  <button
                    type="submit"
              ...
              <div className="p-4 sm:p-5 bg-gray-50/50 border-b border-gray-100">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-600 bg-white transition-all shadow-sm font-medium"
                  />
                </div>
              </div>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden shrink-0 border border-gray-200">
                            {member.photoUrl ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center text-emerald-700 font-bold text-xs bg-emerald-50">
                                {member.name.substring(0, 2)}
                              </div>
                            )}
                          </div>
