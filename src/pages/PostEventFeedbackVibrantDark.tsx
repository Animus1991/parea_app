      ...
      <Card className="p-6">
        {step === 1 && (
          <div className="space-y-8">
              ...
              <div className="flex gap-3 justify-center">
                {moods.map(m => (
                  <button
                    ...
                    className={`flex flex-col items-center gap-1 p-3 rounded-xl border transition-all ${mood === m.emoji ? 'border-fuchsia-9500 bg-fuchsia-900/30 scale-110 shadow-sm' : 'border-gray-700 hover:border-gray-300'}`}
                  >
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  <button key={`vibe-${star}`} onClick={() => setVibeRating(star)} className="p-2 hover:bg-gray-700/60 rounded-full transition-colors">
                    <Star className={`w-8 h-8 transition-colors ${star <= vibeRating ? 'text-fuchsia-400 fill-fuchsia-400' : 'text-white hover:text-fuchsia-400'}`} />
                  </button>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 mt-4">
                <label className="flex items-center gap-3 p-3 border border-gray-700 rounded-lg cursor-pointer hover:bg-gray-700/60">
                  <input type="radio" name="attendance" className="h-4 w-4 text-fuchsia-400 rounded-full border-gray-300" />
            ...
            <div>
              ...
              <div className="space-y-3 mt-4">
                <label className="flex items-center gap-3 p-3 border border-fuchsia-800 bg-fuchsia-950 rounded-lg cursor-pointer">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 border border-gray-700 rounded-xl text-[16.2px] font-medium focus:outline-none focus:ring-2 focus:ring-fuchsia-9500 resize-none"
                rows={3}
              />
        ...
        {step === 2 && (
          <div className="space-y-6 text-center py-8">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-fuchsia-950">
