...
export default function HomeVibrantDark() {
  const { t } = useLanguage();
  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-10 md:pb-0">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-slate-950 via-[#0f172a] to-slate-950 text-white p-6 md:p-10 rounded-[24px] shadow-sm relative overflow-hidden flex flex-col gap-4"
      >
        <HomeHeroModeBar className="relative z-10" />
        <div className="relative z-10 flex-1 w-full">
          <div className={cn("text-fuchsia-300 mb-4", HOME_TYPO.heroBadge)}>
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className={cn("flex items-center gap-2 px-5 py-2.5 bg-fuchsia-500/10 text-fuchsia-300 border border-fuchsia-500/20 hover:bg-fuchsia-500/20 rounded-xl transition-colors", HOME_TYPO.heroMapBtn)}
