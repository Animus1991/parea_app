...
export default function OrganizerDashboardNeonDark() {
    const { t } = useLanguage();
  ...
  return (
    <div className="mx-auto max-w-full space-y-8 pb-12">
      <div className="flex justify-between items-end">
        ...
        <Button className="bg-gradient-to-br from-emerald-900 via-teal-900 to-emerald-800 text-white flex items-center gap-2 text-[14.2457535px] font-bold px-4 hover:bg-black" onClick={() => navigate('/create')}>
      ...
      <Card className="p-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="text-center p-2 bg-emerald-950 rounded-lg border border-emerald-900">
      ...
      <div>
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 noscrollbar">
          {[
            ...
            <button key={tpl.label} onClick={() => navigate('/create')} className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-gray-700 bg-gray-800 hover:bg-emerald-900/30 hover:border-emerald-800 transition-colors text-[12.5px] font-bold text-white">
          ...
          <div className="p-4 bg-gray-800 grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="md:col-span-2 space-y-3">
               ...
               <div className="flex items-center justify-between p-3 bg-gray-800/70 rounded border border-gray-800">
                  ...
                  <div className="flex gap-2">
                    <button className="p-1.5 bg-gray-800 text-emerald-400 rounded shadow-sm border border-gray-700 hover:bg-emerald-900/30" aria-label={t('Μήνυμα ομάδας', 'Message group')} title={t('Μήνυμα ομάδας', 'Message group')}>
             ...
             <div className="space-y-3">
               ...
               <Button variant="ghost" className="w-full text-[15px] text--400 hover:bg-emerald-950 hover:text--400" size="sm">{t(`Ακύρωση`, `Cancel Event`)}</Button>
             </div>
          </div>
        </Card>
          ...
          <div className="p-4 bg-gray-800 grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="md:col-span-2 space-y-3">
               ...
               <div className="flex items-center justify-between p-3 bg-emerald-900/30 rounded border border-emerald-800">
                  <div>
                    <p className="text-[15px] font-bold text-emerald-400">{t(`Ομάδα #1`, `Group #1`)} — 3/4</p>
                    <p className="text-[12.5px] text-emerald-400 mt-0.5">{t(`Νέο μήνυμα`, `New message`)}</p>
                  </div>
                  <div className="flex gap-2">
                    <button className="p-1.5 bg-gray-800 text-emerald-400 rounded shadow-sm border border-emerald-800 hover:bg-emerald-900/50 relative" aria-label={t('Μήνυμα ομάδας', 'Message group')} title={t('Μήνυμα ομάδας', 'Message group')}>
                      <MessageSquare className="w-3.5 h-3.5" />
                      <span className="absolute -top-1 -right-1 w-2 h-2 bg-emerald-9500 rounded-full"></span>
                    </button>
                  </div>
               </div>
             </div>
