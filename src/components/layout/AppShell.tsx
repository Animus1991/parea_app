...
export function TopNav({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    <nav className={cn("flex items-center justify-between px-4 lg:px-6 py-3 border-b h-16 shrink-0", theme === "bento-dark" ? "bg-gray-900 border-gray-800" : theme === "vibrant" ? "bg-white border-fuchsia-100" : theme === "bento" ? "bg-white border-indigo-100" : theme === "neon" ? "bg-white border-emerald-100" : "bg-white border-[#E5E7EB]")}>
      ...
      <div className="flex items-center space-x-3">
        ...
        <NavLink to="/notifications" className={cn("relative transition-colors", theme === "bento-dark" ? "text-white hover:text-emerald-400" : theme === "vibrant" ? "text-gray-500 hover:text-fuchsia-600" : theme === "bento" ? "text-gray-500 hover:text-indigo-600" : theme === "neon" ? "text-gray-500 hover:text-emerald-600" : "text-gray-500 hover:text-[#0E8B8D]")}>
  ...
  return (
    <div className={cn("md:hidden fixed bottom-0 left-0 w-full backdrop-blur-md border-t px-2 pb-4 pt-3 flex items-center justify-around shadow-[0_-4px_20px_rgba(0,0,0,0.05)] z-50", theme === "bento-dark" ? "bg-gray-900/95 border-gray-800" : "bg-white/95 border-gray-200")}>
      <NavLink
        to="/"
        className={({ isActive }) =>
          cn("flex flex-col items-center justify-center gap-1 transition-colors min-w-[60px]", isActive ? (theme === "bento-dark" ? "text-emerald-400" : theme === "vibrant" ? "text-fuchsia-600" : theme === "bento" ? "text-indigo-600" : theme === "neon" ? "text-emerald-600" : "text-[#0E8B8D]") : (theme === "bento-dark" ? "text-white hover:text-emerald-400" : theme === "vibrant" ? "text-gray-400 hover:text-fuchsia-600" : theme === "bento" ? "text-gray-400 hover:text-indigo-600" : theme === "neon" ? "text-gray-400 hover:text-emerald-600" : "text-gray-400 hover:text-[#0E8B8D]"))
        }
      >
      ...
      <div className="flex flex-col items-center justify-center -mt-6">
        <NavLink
          to="/create"
          className={cn("w-10 h-10 rounded-full flex items-center justify-center shadow-lg transition-colors border-[3px] border-white", theme === "vibrant" ? "bg-gradient-to-br from-fuchsia-600 to-orange-500 text-white hover:opacity-90" : theme === "bento" ? "bg-gradient-to-br from-indigo-600 to-violet-500 text-white hover:opacity-90" : theme === "neon" ? "bg-gradient-to-br from-emerald-500 to-teal-500 text-white hover:opacity-90" : "bg-[#111827] text-white hover:bg-black")}
        >
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className={cn("flex h-screen w-full font-sans antialiased overflow-hidden", theme === 'bento-dark' ? 'bg-black text-white' : theme === 'vibrant' ? 'bg-[#FDF2F8] text-[#111827]' : theme === 'bento' ? 'bg-[#F5F3FF] text-[#111827]' : theme === 'neon' ? 'bg-[#ECFDF5] text-[#111827]' : 'bg-[#F3F4F6] text-[#111827]')}>
      <SideNav />
      {isMobileMenuOpen && (
