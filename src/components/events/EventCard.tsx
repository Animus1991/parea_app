        ...
        <div className="flex flex-col gap-2 mb-4">
          ...
          {userGroup && (
            <button
               ...
               className="mt-3 w-full bg-cyan-50 hover:bg-cyan-100 text-cyan-700 py-2 rounded-xl text-xs font-bold transition-colors flex items-center justify-center gap-2 border border-cyan-100"
            >
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  {[
                    ...
                    <button
                      ...
                      className={`text-[9px] font-bold py-1.5 px-2 rounded-lg border transition-colors ${arrivalStatus === status ? "bg-cyan-600 text-white border-cyan-600" : "bg-white text-gray-600 border-gray-200 hover:border-cyan-300"}`}
                    >
                      {status}
                    </button>
                  ))}
              ...
              <div className="space-y-1.5">
                <div className="flex gap-1.5">
                  <button
                    ...
                    className="flex-1 text-[10px] font-bold py-1.5 px-2 bg-white text-cyan-700 border border-cyan-100 rounded-lg hover:bg-cyan-50 flex items-center justify-center gap-1"
                  >
