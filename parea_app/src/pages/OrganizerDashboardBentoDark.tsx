...
export default function OrganizerDashboardBentoDark() {
    const { t } = useLanguage();
  ...
  return (
    <div className="mx-auto max-w-full space-y-8 pb-12">
      <div className="flex justify-between items-end">
        ...
        <Button className="bg-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.5)] border border-gray-700 text-white flex items-center gap-2 text-[14.2457535px] font-bold px-4 hover:bg-black" onClick={() => navigate('/create')}>
      ...
      <div className="space-y-6">
        ...
        <Card className="p-0 overflow-hidden border border-gray-700">
          <div className="p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-gray-800 bg-gray-900/50">
            ...
            <div className="flex gap-2">
              <span className="text-[15px] font-bold text-white bg-gray-800 border-gray-700 text-white px-2 py-1 rounded shadow-sm border border-gray-800">12/20 {t(`θέσεις`, `spots`)}</span>
            </div>
          </div>
          ...
          <div className="p-4 bg-gray-800 border-gray-700 text-white grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="md:col-span-2 space-y-3">
               ...
               <div className="flex items-center justify-between p-3 bg-gray-800/70 rounded border border-gray-800">
                  ...
                  <div className="flex gap-2">
                    <button className="p-1.5 bg-gray-800 border-gray-700 text-white text-emerald-400 rounded shadow-sm border border-gray-700 hover:bg-emerald-900/30" aria-label={t('Μήνυμα ομάδας', 'Message group')} title={t('Μήνυμα ομάδας', 'Message group')}>
        ...
        <Card className="p-0 overflow-hidden border border-gray-700">
          <div className="p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-gray-800 bg-gray-900/50">
            ...
            <div className="flex gap-2">
              <span className="text-[15px] font-bold text-white bg-gray-800 border-gray-700 text-white px-2 py-1 rounded shadow-sm border border-gray-800">6/8 {t(`θέσεις`, `spots`)}</span>
            </div>
          </div>
          ...
          <div className="p-4 bg-gray-800 border-gray-700 text-white grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="md:col-span-2 space-y-3">
               ...
               <div className="flex items-center justify-between p-3 bg-emerald-900/30 rounded border border-emerald-800">
                  ...
                  <div className="flex gap-2">
                    <button className="p-1.5 bg-gray-800 border-gray-700 text-white text-emerald-400 rounded shadow-sm border border-emerald-800 hover:bg-emerald-900/50 relative" aria-label={t('Μήνυμα ομάδας', 'Message group')} title={t('Μήνυμα ομάδας', 'Message group')}>
                      <MessageSquare className="w-3.5 h-3.5" />
