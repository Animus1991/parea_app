...
export default function TrustCenterNeon() {
    const { t } = useLanguage();
  return (
    <div className="mx-auto max-w-full space-y-6 md:space-y-8">
         ...
         <Card className="p-5 space-y-5">
           ...
           <div className="space-y-3">
             ...
             <div className="flex items-center justify-between">
               ...
               <span className="text-[11.2px] text-emerald-600 font-bold cursor-pointer hover:underline tracking-wide">{t(`Επαλήθευση`, `Verify`)}</span>
             </div>
           </div>
      ...
      <Card className="p-5">
        <h3 className="text-[12.5px] font-bold text-[#111827] tracking-wide mb-4 flex items-center gap-1.5">
          <TrendingUp className="w-3.5 h-3.5 text-emerald-600" />{t(`Ιστορικό Εμπιστοσύνης`, `Trust History`)}
        </h3>
