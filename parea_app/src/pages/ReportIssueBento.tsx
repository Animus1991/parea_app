...
export default function ReportIssueBento() {
    const { t } = useLanguage();
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-5">
            <div>
              ...
              <select className="w-full h-11 px-3 rounded-lg border border-gray-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent text-[16.2px] font-medium" required>
            ...
            <div>
              ...
              <textarea 
                className="w-full px-3 py-2.5 rounded-lg border border-gray-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent text-[16.2px] font-medium resize-none" 
                rows={5} 
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center hover:border-indigo-300 hover:bg-indigo-50/30 transition-colors cursor-pointer">
            ...
            <button type="submit" className="w-full bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 text-black py-2.5 rounded-full text-[12.15px] font-bold shadow-sm hover:bg-black transition-colors  tracking-wider">{t(`Υποβολή Αναφοράς`, `Submit Report`)}</button>
          </form>
        </div>
      ) : (
