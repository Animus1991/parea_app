...
export default function SettingsAndPrivacyBento() {
    const { t } = useLanguage();
            ...
            <div className="space-y-3">
              {[
                ...
                <label key={key} className="flex items-center justify-between">
                  ...
                  <div className={`relative w-9 h-5 rounded-full transition-colors cursor-pointer ${notificationPrefs[key as keyof typeof notificationPrefs] ? 'bg-indigo-600' : 'bg-gray-300'}`} onClick={() => handleTogglePref(key as keyof typeof notificationPrefs)}>
